...
ADMIN = "kristian.paivinen@yahoo.com"     # Email authorized to directly run debugging functionalities.
DEBUG_ENABLED = True                      # Disable for additional security.
...
MAX_NUMBER_FILEGENERATION = 999999        # Useful to set higher in order to increase randomness.
                                          ...
                                          # Directory where everything generated by the application will be located.
